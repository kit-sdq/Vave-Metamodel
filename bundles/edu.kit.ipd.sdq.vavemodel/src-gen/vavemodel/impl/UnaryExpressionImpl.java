 ...
 * </p>
 * <ul>
 *   <li>{@link vavemodel.impl.UnaryExpressionImpl#getTerm <em>Term</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class UnaryExpressionImpl<T extends Option> extends ExpressionImpl<T> implements UnaryExpression<T> {
	...
	protected EClass eStaticClass() {
		return VavemodelPackage.Literals.UNARY_EXPRESSION;
	}
	...
	public void setTerm(Term<T> newTerm) {
		if (newTerm != term) {
			...
			if (term != null)
				msgs = ((InternalEObject)term).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - VavemodelPackage.UNARY_EXPRESSION__TERM, null, msgs);
			if (newTerm != null)
				msgs = ((InternalEObject)newTerm).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - VavemodelPackage.UNARY_EXPRESSION__TERM, null, msgs);
			msgs = basicSetTerm(newTerm, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VavemodelPackage.UNARY_EXPRESSION__TERM, newTerm, newTerm));
	}
