		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DeltaModule_deltamodule_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DeltaModule_deltamodule_feature", "_UI_DeltaModule_type"),
				 VavemodelPackage.Literals.DELTA_MODULE__DELTAMODULE,
				 true,
				 false,
				 true,
				 null,
